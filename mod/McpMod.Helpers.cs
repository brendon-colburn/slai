...
public static partial class McpMod
{
    ...
    // --- Read-only helpers copied from STS2MCP's McpMod.Actions.cs ---
    // Used by StateBuilder to report informational fields (e.g. "can_proceed"
    // on Crystal Sphere screen, unrevealed timeline epoch ids on main menu).
    // These don't take actions; they just observe game state, so they belong
    // here in the read-only mod rather than in the action surface we removed.
